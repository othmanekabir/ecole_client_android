...
public class AddNote extends AppCompatActivity {
    ...
    private void processSave(String matiere, String etudiant, String note){
        ...
        System.out.println("http://192.168.1.40:8080/etudiants/addstudentnote/"+etudiant+"/"+matiere+"/"+note);
        Request request = new Request.Builder()
                .url("http://192.168.1.40:8080/etudiants/addstudentnote/"+etudiant+"/"+matiere+"/"+note)
    ...
    private void remplirEtudiant(String classe,AutoCompleteTextView ac){
        ...
        OkHttpClient client = new OkHttpClient();
        Request request = new Request.Builder()
                .url("http://192.168.1.40:8080/etudiants/etudiants/classes/"+classe)
                .build();
        client.newCall(request).enqueue(new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
    ...
    private void remplirMatiere(AutoCompleteTextView ac){
        ...
        OkHttpClient client = new OkHttpClient();
        Request request = new Request.Builder()
                .url("http://192.168.1.40:8080/etudiants/matieres")
                .build();
        client.newCall(request).enqueue(new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
    ...
    private void remplirClasse(AutoCompleteTextView ac){
        ...
        OkHttpClient client = new OkHttpClient();
        Request request = new Request.Builder()
                .url("http://192.168.1.40:8080/etudiants/classes")
                .build();
        client.newCall(request).enqueue(new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
