...
public class UpdateNote extends AppCompatActivity {
    ...
    private void processdelete(Intent i){
        ...
        String req = "http://192.168.1.40:8080/etudiants/deletestudentnote/"+idEtudiantMatiere;
    ...
    private void processupdate(Intent i, String note){
        ...
        OkHttpClient client = new OkHttpClient();
        RequestBody reqbody = RequestBody.create(null, new byte[0]);
        System.out.println("http://192.168.1.40:8080/etudiants/updatestudentnote/"+idEtudiant+"/"+matiere+"/"+note);
        Request request = new Request.Builder()
                .url("http://192.168.1.40:8080/etudiants/updatestudentnote/"+idEtudiant+"/"+matiere+"/"+note)
